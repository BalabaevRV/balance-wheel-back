...
export const getUserInfoById = async (id: number): Promise<IUser> => {
    ...
    try {
        ...
        return  { user_id: existingUser.user_id, login: existingUser.login, name: existingUser.name, email: existingUser.email, wheels: currentUserWheels, records: currentUserRecords }
